...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2013 at 12:51 PM
...
--
-- Table structure for table `dyicl_assets`
--

CREATE TABLE IF NOT EXISTS `dyicl_assets` (
...
--
-- Dumping data for table `dyicl_assets`
--

INSERT INTO `dyicl_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `dyicl_associations`
--

CREATE TABLE IF NOT EXISTS `dyicl_associations` (
...
--
-- Table structure for table `dyicl_banners`
--

CREATE TABLE IF NOT EXISTS `dyicl_banners` (
...
--
-- Table structure for table `dyicl_banner_clients`
--

CREATE TABLE IF NOT EXISTS `dyicl_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `dyicl_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `dyicl_banner_tracks` (
...
--
-- Table structure for table `dyicl_categories`
--

CREATE TABLE IF NOT EXISTS `dyicl_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dyicl_categories`
--

INSERT INTO `dyicl_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Table structure for table `dyicl_contact_details`
--

CREATE TABLE IF NOT EXISTS `dyicl_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `dyicl_content`
--

CREATE TABLE IF NOT EXISTS `dyicl_content` (
...
--
-- Table structure for table `dyicl_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `dyicl_content_frontpage` (
...
--
-- Table structure for table `dyicl_content_rating`
--

CREATE TABLE IF NOT EXISTS `dyicl_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dyicl_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `dyicl_core_log_searches` (
...
--
-- Table structure for table `dyicl_extensions`
--

CREATE TABLE IF NOT EXISTS `dyicl_extensions` (
...
--
-- Dumping data for table `dyicl_extensions`
--

INSERT INTO `dyicl_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `dyicl_finder_filters`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_filters` (
...
--
-- Table structure for table `dyicl_finder_links`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links` (
...
--
-- Table structure for table `dyicl_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms0` (
...
--
-- Table structure for table `dyicl_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dyicl_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `dyicl_finder_taxonomy`
--

INSERT INTO `dyicl_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `dyicl_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `dyicl_finder_terms`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_terms` (
...
--
-- Table structure for table `dyicl_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `dyicl_finder_terms_common`
--

INSERT INTO `dyicl_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `dyicl_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dyicl_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `dyicl_finder_types`
--

CREATE TABLE IF NOT EXISTS `dyicl_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dyicl_languages`
--

CREATE TABLE IF NOT EXISTS `dyicl_languages` (
...
--
-- Dumping data for table `dyicl_languages`
--

INSERT INTO `dyicl_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `dyicl_menu`
--

CREATE TABLE IF NOT EXISTS `dyicl_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dyicl_menu`
--

INSERT INTO `dyicl_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `dyicl_menu_types`
--

CREATE TABLE IF NOT EXISTS `dyicl_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dyicl_menu_types`
--

INSERT INTO `dyicl_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `dyicl_messages`
--

CREATE TABLE IF NOT EXISTS `dyicl_messages` (
...
--
-- Table structure for table `dyicl_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `dyicl_messages_cfg` (
...
--
-- Table structure for table `dyicl_modules`
--

CREATE TABLE IF NOT EXISTS `dyicl_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dyicl_modules`
--

INSERT INTO `dyicl_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `dyicl_modules_menu`
--

CREATE TABLE IF NOT EXISTS `dyicl_modules_menu` (
...
--
-- Dumping data for table `dyicl_modules_menu`
--

INSERT INTO `dyicl_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `dyicl_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `dyicl_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dyicl_overrider`
--

CREATE TABLE IF NOT EXISTS `dyicl_overrider` (
...
--
-- Table structure for table `dyicl_redirect_links`
--

CREATE TABLE IF NOT EXISTS `dyicl_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `dyicl_schemas`
--

CREATE TABLE IF NOT EXISTS `dyicl_schemas` (
...
--
-- Dumping data for table `dyicl_schemas`
--

INSERT INTO `dyicl_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.11');

-- --------------------------------------------------------

--
-- Table structure for table `dyicl_session`
--

CREATE TABLE IF NOT EXISTS `dyicl_session` (
...
--
-- Dumping data for table `dyicl_session`
--

INSERT INTO `dyicl_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('fiqeqmbf3tpslfu8l3lf79h325', 0, 1, '1368701284', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1368701284;s:18:"session.timer.last";i:1368701284;s:17:"session.timer.now";i:1368701284;s:22:"session.client.browser";s:101:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.64 Safari/537.31";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"e0a78def45ebe6180a2e5060825b229d";}', 0, '', ''),
('i6952no6eq65o6cdqt6vme0196', 1, 0, '1368701310', '__default|a:8:{s:15:"session.counter";i:5;s:19:"session.timer.start";i:1368701300;s:18:"session.timer.last";i:1368701308;s:17:"session.timer.now";i:1368701310;s:22:"session.client.browser";s:101:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.64 Safari/537.31";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"962";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:20:"duongldd90@gmail.com";s:8:"password";s:65:"90065c63f6255da28e545d98d55ce340:5kyejOaXP9yXY2H7imJ6al6majJEH8CX";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-05-16 10:47:49";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"1b86e2222cc85f5a0c5dc7d0e89c1214";}', 962, 'admin', '');

-- --------------------------------------------------------

--
-- Table structure for table `dyicl_template_styles`
--

CREATE TABLE IF NOT EXISTS `dyicl_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dyicl_template_styles`
--

INSERT INTO `dyicl_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `dyicl_updates`
--

CREATE TABLE IF NOT EXISTS `dyicl_updates` (
...
--
-- Dumping data for table `dyicl_updates`
--

INSERT INTO `dyicl_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
--
-- Table structure for table `dyicl_update_categories`
--

CREATE TABLE IF NOT EXISTS `dyicl_update_categories` (
...
--
-- Table structure for table `dyicl_update_sites`
--

CREATE TABLE IF NOT EXISTS `dyicl_update_sites` (
...
--
-- Dumping data for table `dyicl_update_sites`
--

INSERT INTO `dyicl_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1368701308),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1368701308),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1368701308);

-- --------------------------------------------------------

--
-- Table structure for table `dyicl_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `dyicl_update_sites_extensions` (
...
--
-- Dumping data for table `dyicl_update_sites_extensions`
--

INSERT INTO `dyicl_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `dyicl_usergroups`
--

CREATE TABLE IF NOT EXISTS `dyicl_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `dyicl_usergroups`
--

INSERT INTO `dyicl_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Table structure for table `dyicl_users`
--

CREATE TABLE IF NOT EXISTS `dyicl_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `dyicl_users`
--

INSERT INTO `dyicl_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(962, 'Super User', 'admin', 'duongldd90@gmail.com', '90065c63f6255da28e545d98d55ce340:5kyejOaXP9yXY2H7imJ6al6majJEH8CX', 'deprecated', 0, 1, '2013-05-16 10:47:49', '2013-05-16 10:48:25', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dyicl_user_notes`
--

CREATE TABLE IF NOT EXISTS `dyicl_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dyicl_user_profiles`
--

CREATE TABLE IF NOT EXISTS `dyicl_user_profiles` (
...
--
-- Table structure for table `dyicl_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `dyicl_user_usergroup_map` (
...
--
-- Dumping data for table `dyicl_user_usergroup_map`
--

INSERT INTO `dyicl_user_usergroup_map` (`user_id`, `group_id`) VALUES
(962, 8);

-- --------------------------------------------------------

--
-- Table structure for table `dyicl_viewlevels`
--

CREATE TABLE IF NOT EXISTS `dyicl_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `dyicl_viewlevels`
--

INSERT INTO `dyicl_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `dyicl_weblinks`
--

CREATE TABLE IF NOT EXISTS `dyicl_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
